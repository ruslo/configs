...
export COLOR_ON_BHI_IBLACK='\[\e[0;100m\]'   # Black
export COLOR_ON_BHI_IRED='\[\e[0;101m\]'     # Red
export COLOR_ON_BHI_IGREEN='\[\e[0;102m\]'   # Green
export COLOR_ON_BHI_IYELLOW='\[\e[0;103m\]'  # Yellow
export COLOR_ON_BHI_IBLUE='\[\e[0;104m\]'    # Blue
export COLOR_ON_BHI_IPURPLE='\[\e[10;95m\]'  # Purple
export COLOR_ON_BHI_ICYAN='\[\e[0;106m\]'    # Cyan
export COLOR_ON_BHI_IWHITE='\[\e[0;107m\]'   # White
